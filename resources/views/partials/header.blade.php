<nav class="navbar navbar-expand-lg navbar-light" style='background-color: #c84c4e;'>
  <a class="navbar-brand" href="{{asset('home')}}"><img class="logo" src="{{asset('images/dh-logo.png')}}" alt="logo" width="75px"></a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active"><a class="nav-link" href="{{asset('news')}}">Novedades</a></li>
      <li class="nav-item"><a class="nav-link" href="{{asset('offers')}}">Ofertas</a></li>
      <li class="nav-item"><a class="nav-link" href="{{asset('hotsales')}}">Hot Sale</a></li>
    ...
    <form class="form-inline my-2 my-md-0">
      ...
      <button class="btn btn-outline-dark my-2 my-sm-0" type="submit" style='border-top-left-radius: 0px;border-bottom-left-radius: 0px;border-top-right-radius: 5px;border-bottom-right-radius: 5px;'><img src="{{asset('images/icon-search.jpg')}}" alt="iconSearch" width="20px"></button>
    </form>

    <div class="class="d-flex justify-content-end"">
      <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="myDropDown" data-toggle="dropdown">Mi Cuenta <img src="<?php //if($auth->estaLogueado()):?><?php //else: ?>{{asset('images/default-profile.jpg')}}<?php //endif; ?>" width="35px"></a>
          <div class="dropdown-menu" aria-labelledby="myDropDown">
            <?php // if($auth->estaLogueado()): ?>
              <a class="dropdown-item" href="profile.php?username=">Mi perfil</a> <!--{{asset('')}}-->
              <a class="dropdown-item" href="settings.php">Configuraciones</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="logout.php">Log Out</a>
            <?php // else: ?>
              <a class="dropdown-item" href="{{asset('login')}}">Log In</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="{{asset('signup')}}">Sign Up</a>
            <?php //endif; ?>
          </div>
        </ul>
      </div>
